...
python finetune.py agent=diffusion_unet exp_name=bimanual_test wandb.name=bimanual_test buffer_path=/home/fomo_data/test.pkl max_iterations=500000 trainer=bc_cos_sched ac_chunk=16 train_transform=medium task.train_buffer.cam_indexes=[0] agent.features.feature_dim=256
